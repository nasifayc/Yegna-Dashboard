...
const CardData: React.FC<CardProps> = ({
  ...
  return (
    <Card className="flex max-w-72 min-w-28 items-center justify-between p-4 shadow-md bg-background-light dark:bg-gray-800 dark:border-none cursor-pointer transition">
      <div>
